...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'conversionguard'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '2908c8e2d4702b5e5d64046a037d31de'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', 'bf9e6e1f0217ac5d6fb2b612ab1c91a0'),
    ...
    */
    ...
    'webhooks' => [
            [
                ...
                'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://phpstack-102119-2965010.cloudwaysapps.com/webhook/app-uninstalled')
            ],
    ],
